    ...
    return (
        <>
            ...
            <section id="sobre" className="relative overflow-hidden pt-[120px] md:pt-[184px]">
                ...
                <div className="mx-auto max-w-7xl px-4  pb-8 md:pb-24 grid md:grid-cols-2 gap-10 items-center">
                ...
                <div className="mx-auto max-w-7xl px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
                    <div className="relative">
                        ...
                        {/* <p className="mt-4 text-base md:text-lg text-[var(--text)]/80">Soluções completas para ambientes de alto padrão.</p> */}
                        <p className="mt-4 text-sm md:text-base text-[var(--text)]/70">Na OMMA, nosso foco é entregar soluções completas em obras, com gestão integral que elimina preocupações e assegura previsibilidade para cada cliente. Acreditamos que transformar um projeto em realidade exige mais do que um bom design: exige excelência na gestão, agilidade na execução e compromisso com resultados.</p>
                        <p className="mt-4 text-sm md:text-base text-[var(--text)]/70">Nosso propósito é ser a parceira estratégica que transforma ambientes em experiências, oferecendo segurança, eficiência e tranquilidade em cada entrega.</p>
                        <p className="mt-4 text-sm md:text-base text-[var(--text)]/70">Nossa equipe, formada por engenheiros, arquitetos e especialistas em engenharia corporativa, é a alma da OMMA. Mais do que construir estruturas, cultivamos relacionamentos sólidos, baseados na transparência, no profissionalismo e na busca constante por superar expectativas.</p>
                        <div className="mt-8 flex items-center gap-3">
                            <a href="#contato" className="inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-medium tracking-tight bg-gradient-to-r from-yellow-500/20 to-amber-500/20 border border-yellow-500/40 hover:from-yellow-500/30 hover:to-amber-500/30 transition-colors">
                                <span className="text-yellow-400">Solicite um orçamento agora</span>
                            </a>
                            <div className="hidden sm:flex items-center gap-2 text-[var(--text)]/60 text-sm">
                                <span>Compromisso com prazos e segurança</span>
                            </div>
