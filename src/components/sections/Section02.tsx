...
async function getSection1Data(): Promise<Section1Data> {
  ...
  return {
    section1Text: data?.section1?.section1Text || [],
    items: data?.section1?.items || [],
    button: data?.section1?.button || null,
    cards: data?.section1?.cards || [],
    sectionImage1: data?.section1?.sectionImage1 || null,
    sectionImage2: data?.section1?.sectionImage2 || null,
    sectionImage3: data?.section1?.sectionImage3 || null
  };
}

const Section02 = async () => {
  const {
    section1Text,
    items,
    button,
            ...
            <div className="grid grid-cols-6 sm:grid-cols-12 gap-4 sm:gap-6">
              <div className="col-span-6 sm:col-span-8">
                <div className="aspect-[470/419] w-full overflow-hidden rounded-3xl ring-1 ring-white/10 bg-white/5">
                  <img
                    src={sectionImage1 ? urlFor(sectionImage1).url() : undefined}
              ...
              <div className="col-span-6 sm:col-span-4">
                <div className="aspect-[326/289] w-full overflow-hidden rounded-3xl ring-1 ring-white/10 bg-white/5">
                  <img
                    src={sectionImage2 ? urlFor(sectionImage2).url() : undefined}
              ...
              <div className="col-span-6 sm:col-span-5 sm:col-start-5">
                <div className="aspect-square w-full overflow-hidden rounded-3xl ring-1 ring-white/10 bg-white/5">
                  <img
                    src={sectionImage3 ? urlFor(sectionImage3).url() : undefined}
            ...
            {cards.map((item, idx) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-lg" style={{ fontFamily: 'Manrope, Inter', fontWeight: 700 }}>
                      {item.title}
                    </p>
                  </div>
                </div>
