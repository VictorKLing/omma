...
const navLinks = [
  ...
  { href: "/trabalhe-conosco", label: "Trabalhe conosco", highlight: true },
];
                            ...
                            <nav className="hidden md:flex items-center gap-7 text-sm" style={{ fontFamily: 'DM Sans, Inter' }}>
                                {navLinks.map((link) => (
                                    <Link
                                        key={link.href}
                                        href={link.href}
                                        className={`text-white/90 hover:text-white transition inline-flex items-center gap-2
                                    ...
                                    {navLinks.map((link) => (
                                        <li key={link.href}>
                                            ...
                                            className={`block rounded-lg px-4 py-2 text-sm font-medium 
                                                ${pathname === link.href ? "bg-yellow-400 text-white" : "text- hover:bg-yellow-400 hover:text-white"}`}
                                            >
                                            {link.label}
                                            </Link>
                                        </li>
